				...
				'st_button_clipmemo'     : {
					...
					menu: {
						'st_button_clipmemo_default' : {
							...
							icon    : false,
							tooltip : 'メモ',
							callback: wrapAsText('[st-cmemo fontawesome="fa-file-text-o" iconcolor="#919191" bgcolor="#fafafa" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_external_link' : {
							text    : '外部リンク',
							icon    : false,
							tooltip : '外部リンク',
							callback: wrapAsText('[st-cmemo fontawesome="fa-external-link" iconcolor="#BDBDBD" bgcolor="#fafafa" color="#757575" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_bookmark' : {
							text    : 'ブックマーク',
							icon    : false,
							tooltip : 'ブックマーク',
							callback: wrapAsText('[st-cmemo fontawesome="fa-bookmark" iconcolor="#BDBDBD" bgcolor="#fafafa" color="#757575" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_info' : {
							text    : 'おしらせ',
							icon    : false,
							tooltip : 'おしらせ',
							callback: wrapAsText('[st-cmemo fontawesome="fa-bullhorn" iconcolor="#FFEB3B" bgcolor="#FFFDE7" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_question' : {
							text    : 'はてな',
							icon    : false,
							tooltip : 'はてな',
							callback: wrapAsText('[st-cmemo fontawesome="fa-question-circle" iconcolor="#4FC3F7" bgcolor="#E1F5FE" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_comment' : {
							text    : 'コメント',
							icon    : false,
							tooltip : 'コメント',
							callback: wrapAsText('[st-cmemo fontawesome="fa-comments" iconcolor="#F48FB1" bgcolor="#FCE4EC" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_code' : {
							text    : 'コード',
							icon    : false,
							tooltip : 'コード',
							callback: wrapAsText('[st-cmemo fontawesome="fa-code" iconcolor="#919191" bgcolor="#fafafa" color="#000000" bordercolor="" borderwidth="" iconsize="150"]', '[/st-cmemo]')
						},'st_button_clipmemo_point' : {
							text    : 'ポイント',
							icon    : false,
							tooltip : 'ポイント',
							callback: wrapAsText('[st-cmemo fontawesome="fa-lightbulb-o" iconcolor="#FFA726" bgcolor="#FFF3E0" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_user' : {
							text    : 'ユーザー',
							icon    : false,
							tooltip : 'ユーザー',
							callback: wrapAsText('[st-cmemo fontawesome="fa-user" iconcolor="#4FC3F7" bgcolor="#E1F5FE" color="#000000" bordercolor="" borderwidth="" iconsize="150"]', '[/st-cmemo]')
						},'st_button_clipmemo_bigginer' : {
							text    : '初心者',
							icon    : false,
							tooltip : '初心者',
							callback: wrapAsText('[st-cmemo fontawesome="st-svg-bigginer_l" iconcolor="#9CCC65" bgcolor="#F1F8E9" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_exclamation' : {
							text    : '注意文',
							icon    : false,
							tooltip : '注意文',
							callback: wrapAsText('[st-cmemo fontawesome="fa-exclamation-circle" iconcolor="#ef5350" bgcolor="#ffebee" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_exclamation_gray' : {
							text    : '注意文（グレー）',
							icon    : false,
							tooltip : '注意文（グレー）',
							callback: wrapAsText('[st-cmemo fontawesome="fa-exclamation-circle" iconcolor="#919191" bgcolor="#fafafa" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_guide' : {
							text    : '[?] ガイド※使用不可',
							icon    : false,
							tooltip : '[?] ガイド※使用不可',
							callback: wrapAsText('[st-cmemo fontawesome="Webアイコン" iconcolor="アイコンの色" bgcolor="背景色" color="文字色" bordercolor="ボーダー色" borderwidth="枠線の太さ（px）" iconsize="アイコンサイズ（%）"]ここにテキスト', '[/st-cmemo]')
						},
					},
				},
				'st_button_clipmemo_guide_text'     : {
					...
					menu: {
						'st_button_clipmemo_guide_memo' : {
							...
							icon    : false,
							tooltip : 'メモ',
							callback: wrapAsText('[st-cmemo myclass="st-text-guide st-text-guide-memo" fontawesome="fa-pencil" iconcolor="#919191" bgcolor="#fafafa" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_guide_sankou' : {
							text    : '参考',
							icon    : false,
							tooltip : '参考',
							callback: wrapAsText('[st-cmemo myclass="st-text-guide st-text-guide-sankou" fontawesome="fa-quote-left" iconcolor="#919191" bgcolor="#fafafa" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_guide_kanren' : {
							text    : '関連',
							icon    : false,
							tooltip : '関連',
							callback: wrapAsText('[st-cmemo myclass="st-text-guide st-text-guide-kanren" fontawesome="fa-file-text-o" iconcolor="#919191" bgcolor="#fafafa" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_guide_attention' : {
							text    : '注意',
							icon    : false,
							tooltip : '注意',
							callback: wrapAsText('[st-cmemo myclass="st-text-guide st-text-guide-attention" fontawesome="fa-exclamation-circle" iconcolor="#ef5350" bgcolor="#ffebee" color="#000000" bordercolor="#ffcdd2" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_guide_point' : {
							text    : 'Check',
							icon    : false,
							tooltip : 'Check',
							callback: wrapAsText('[st-cmemo myclass="st-text-guide st-text-guide-point" fontawesome="fa-check" iconcolor="#FF8F00" bgcolor="#FFF8E1" color="#000000" bordercolor="#FFE082" borderwidth="" iconsize="150"]', '[/st-cmemo]')
						},
						'st_button_clipmemo_guide_next' : {
							text    : '次へ進む',
							icon    : false,
							tooltip : '次へ進む',
							callback: wrapAsText('[st-cmemo myclass="st-text-guide st-text-guide-next" fontawesome="fa-arrow-right faa-horizontal animated" iconcolor="#919191" bgcolor="#fafafa" color="#000000" bordercolor="" borderwidth="" iconsize="150"]', '[/st-cmemo]')
						},
						'st_button_clipmemo_guide_prev' : {
							text    : '前に戻る',
							icon    : false,
							tooltip : '前に戻る',
							callback: wrapAsText('[st-cmemo myclass="st-text-guide st-text-guide-prev" fontawesome="fa-arrow-left" iconcolor="#919191" bgcolor="#fafafa" color="#000000" bordercolor="" borderwidth="" iconsize="150"]', '[/st-cmemo]')
						},
						'st_button_clipmemo_guide_question' : {
							text    : '質問',
							icon    : false,
							tooltip : '質問',
							callback: wrapAsText('[st-cmemo myclass="st-text-guide st-text-guide-question" fontawesome="fa-quora" iconcolor="#29B6F6" bgcolor="#E1F5FE" color="#000000" bordercolor="#81D4FA" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
						'st_button_clipmemo_guide_answer' : {
							text    : '回答',
							icon    : false,
							tooltip : '回答',
							callback: wrapAsText('[st-cmemo myclass="st-text-guide st-text-guide-answer" fontawesome="fa-font" iconcolor="#919191" bgcolor="#fafafa" color="#000000" bordercolor="" borderwidth="" iconsize=""]', '[/st-cmemo]')
						},
					},
				},
				'st_button_minihukidashi': {
					...
					menu: {
							'st_button_minihukidashi_default' : {
								...
								icon    : false,
								tooltip : '基本',
								callback: wrapAsText('[st-minihukidashi fontawesome="" fontsize="" fontweight="" bgcolor="#f3f3f3" color="#000000" margin="0 0 20px 0" radius="" position="" myclass="" add_boxstyle=""]', '[/st-minihukidashi]')
							},
							'st_button_minihukidashi_orange' : {
								text    : 'オレンジ',
								icon    : false,
								tooltip : 'オレンジ',
								callback: wrapAsText('[st-minihukidashi fontawesome="" fontsize="" fontweight="" bgcolor="#FFB74D" color="#fff" margin="0 0 20px 0" radius="" position="" myclass="" add_boxstyle=""]', '[/st-minihukidashi]')
							},
							'st_button_minihukidashi_pink' : {
								text    : 'ピンク',
								icon    : false,
								tooltip : 'ピンク',
								callback: wrapAsText('[st-minihukidashi fontawesome="" fontsize="" fontweight="" bgcolor="#F48FB1" color="#fff" margin="0 0 20px 0" radius="" position="" myclass="" add_boxstyle=""]', '[/st-minihukidashi]')
							},
							'st_button_minihukidashi_blue' : {
								text    : 'ブルー',
								icon    : false,
								tooltip : 'ブルー',
								callback: wrapAsText('[st-minihukidashi fontawesome="" fontsize="" fontweight="" bgcolor="#4FC3F7" color="#fff" margin="0 0 20px 0" radius="" position="" myclass="" add_boxstyle=""]', '[/st-minihukidashi]')
							},
							'st_button_minihukidashi_green' : {
								text    : 'グリーン',
								icon    : false,
								tooltip : 'グリーン',
								callback: wrapAsText('[st-minihukidashi fontawesome="" fontsize="" fontweight="" bgcolor="#7CB342" color="#fff" margin="0 0 20px 0" radius="" position="" myclass="" add_boxstyle=""]', '[/st-minihukidashi]')
							},
							'st_button_minihukidashi_red' : {
								text    : 'レッド',
								icon    : false,
								tooltip : 'レッド',
								callback: wrapAsText('[st-minihukidashi fontawesome="" fontsize="" fontweight="" bgcolor="#f44336" color="#fff" margin="0 0 20px 0" radius="" position="" myclass="" add_boxstyle=""]', '[/st-minihukidashi]')
							},
							'st_button_minihukidashi_mybox' : {
								text    : '+ マイボックス',
								icon    : false,
								tooltip : '+ マイボックス',
								callback: wrapAsHtml('[st-div class="" margin="0 0 15px 0" padding="0 0 0 0" add_style=""][st-minihukidashi fontawesome="e" fontsize="" fontweight="bold" bgcolor="#f3f3f3" color="" margin="0" radius="" position="" myclass="" add_boxstyle=""]ふきだしテキスト[/st-minihukidashi][/st-div][st-mybox title="" fontawesome="" color="" bordercolor="" bgcolor="#f3f3f3" borderwidth="" borderradius="5" titleweight="bold" fontsize="" myclass="st-mybox-class" margin="0 0 25px 0"]<p>', '</p>[/st-mybox]')
							},
							'st_button_minihukidashi_guide' : {
								text    : '[?] ガイド※使用不可',
								icon    : false,
								tooltip : '[?] ガイド※使用不可',
								callback: wrapAsText('[st-minihukidashi fontawesome="Webアイコン" fontsize="文字サイズ（%）" fontweight="文字の太さ（bold）" bgcolor="背景色" color="文字色" margin="余白（上 右 下 左）" radius="角の丸み" position="吹き出し位置（on）" myclass="CSSクラス" add_boxstyle="全体を囲むdivに追加するCSS"]ここにテキスト', '[/st-minihukidashi]')
							},
						},
					},
					...
					'st_button_marumozi': {
						...
						menu: {
							'st_button_marumozi_default': {
								text    : '基本',
								icon    : false,
								callback: wrapAsText('[st-marumozi fontawesome="" bgcolor="#f3f3f3" bordercolor="" color="#000000" radius="30" margin="0 10px 0 0" myclass=""]', '[/st-marumozi]')
							},
							'st_button_marumozi_orange': {
								text    : 'オレンジ',
								icon    : false,
								callback: wrapAsText('[st-marumozi fontawesome="" bgcolor="#FFB74D" bordercolor="" color="#fff" radius="30" margin="0 10px 0 0" myclass=""]', '[/st-marumozi]')
							},
							'st_button_marumozi_pink': {
								text    : 'ピンク',
								icon    : false,
								callback: wrapAsText('[st-marumozi fontawesome="" bgcolor="#F48FB1" bordercolor="" color="#fff" radius="30" margin="0 10px 0 0" myclass=""]', '[/st-marumozi]')
							},
							'st_button_marumozi_blue': {
								text    : 'ブルー',
								icon    : false,
								callback: wrapAsText('[st-marumozi fontawesome="" bgcolor="#4FC3F7" bordercolor="" color="#fff" radius="30" margin="0 10px 0 0" myclass=""]', '[/st-marumozi]')
							},
							'st_button_marumozi_exclamation': {
								text    : 'うすい注意',
								icon    : false,
								callback: wrapAsText('[st-marumozi fontawesome="fa-exclamation-circle" bgcolor="#ffebee" bordercolor="" color="#ef5350" radius="30" margin="0 10px 0 0" myclass=""]', '[/st-marumozi]')
							},
							'st_button_marumozi_exclamation_b': {
								text    : '注意',
								icon    : false,
								callback: wrapAsText('[st-marumozi fontawesome="fa-exclamation-circle" bgcolor="#ef5350" bordercolor="" color="#fff" radius="30" margin="0 10px 0 0" myclass=""]', '[/st-marumozi]')
							},
							'st_button_marumozi_guide': {
								text    : '[?] ガイド※使用不可',
								icon    : false,
								callback: wrapAsText('[st-marumozi fontawesome="Webアイコン" bgcolor="背景色" bordercolor="ボーダー色" color="文字色" radius="角丸（px）" margin="余白（上 右 下 左）" myclass="CSSクラス"]ここにテキスト', '[/st-marumozi]')
							},
						},
					},
					'st_button_marumozi_big': {
						...
						menu: {
							'st_button_marumozi_big_default': {
								text    : '基本',
								icon    : false,
								callback: wrapAsText('[st-marumozi-big fontawesome="" bgcolor="#f3f3f3" bordercolor="" color="#000000" radius="30" margin="0 10px 10px 0" myclass=""]', '[/st-marumozi-big]')
							},
							'st_button_marumozi_big_orange': {
								text    : 'オレンジ',
								icon    : false,
								callback: wrapAsText('[st-marumozi-big fontawesome="" bgcolor="#FFB74D" bordercolor="" color="#fff" radius="30" margin="0 10px 10px 0" myclass=""]', '[/st-marumozi-big]')
							},
							'st_button_marumozi_big_pink': {
								text    : 'ピンク',
								icon    : false,
								callback: wrapAsText('[st-marumozi-big fontawesome="" bgcolor="#F48FB1" bordercolor="" color="#fff" radius="30" margin="0 10px 10px 0" myclass=""]', '[/st-marumozi-big]')
							},
							'st_button_marumozi_big_blue': {
								text    : 'ブルー',
								icon    : false,
								callback: wrapAsText('[st-marumozi-big fontawesome="" bgcolor="#4FC3F7" bordercolor="" color="#fff" radius="30" margin="0 10px 10px 0" myclass=""]', '[/st-marumozi-big]')
							},
							'st_button_marumozi_big_question': {
								text    : 'はてな',
								icon    : false,
								callback: wrapAsText('[st-marumozi-big fontawesome="fa-question-circle" bgcolor="#4FC3F7" bordercolor="" color="#fff" radius="30" margin="0 10px 10px 0" myclass=""]', '[/st-marumozi-big]')
							},
							'st_button_marumozi_big_check': {
								text    : 'チェック',
								icon    : false,
								callback: wrapAsText('[st-marumozi-big fontawesome="fa-check-circle" bgcolor="#FFB74D" bordercolor="" color="#fff" radius="30" margin="0 10px 10px 0" myclass=""]', '[/st-marumozi-big]')
							},
							'st_button_marumozi_big_exclamation': {
								text    : 'うすい注意',
								icon    : false,
								callback: wrapAsText('[st-marumozi-big fontawesome="fa-exclamation-circle" bgcolor="#ffebee" bordercolor="" color="#ef5350" radius="30" margin="0 10px 10px 0" myclass=""]', '[/st-marumozi-big]')
							},
							'st_button_marumozi_big_exclamation_b': {
								text    : '注意',
								icon    : false,
								callback: wrapAsText('[st-marumozi-big fontawesome="fa-exclamation-circle" bgcolor="#ef5350" bordercolor="" color="#fff" radius="30" margin="0 10px 10px 0" myclass=""]', '[/st-marumozi-big]')
							},
							'st_button_marumozi_big_guide': {
								text    : '[?] ガイド※使用不可',
								icon    : false,
								callback: wrapAsText('[st-marumozi-big fontawesome="Webアイコン" bgcolor="背景色" bordercolor="ボーダー色" color="文字色" radius="角丸（px）" margin="余白（上 右 下 左）" myclass="CSSクラス"]ここにテキスト', '[/st-marumozi-big]')
							},
						},
					},
					'st_design_html5'   : {
			...
			'st_button_boxdesign'        : {
				...
				menu: {
					...
					'st_button_mybox'        : {
						...
						menu: {
							...
							'st_button_mybox_sc' : {
								...
								callback: wrapAsHtml('[st-scbox title="" fontawesome="" color="#000" bordercolor="" bgcolor="#fafafa" borderwidth="" borderradius="0" titleweight="bold" fontsize="" myclass="st-mybox-class" margin="25px 0 25px 0"]<p>', '</p>[/st-scbox]')
							},
					...
					'st_button_mybox_intitle'     : {
						...
						menu: {
							'st_button_mybox_intitle_default' : {
								...
								icon    : false,
								tooltip : 'メモ',
								callback: wrapAsHtml('[st-mybox title="メモ" fontawesome="fa-file-text-o" color="#727272" bordercolor="#ff0000" bgcolor="#FAFAFA" borderwidth="0" borderradius="5" titleweight="bold" title_bordercolor="" fontsize="" myclass="st-mybox-class st-title-under" margin="25px 0 25px 0"]<p>', '</p>[/st-mybox]')
							},
							'st_button_mybox_intitle_memo_titleborder' : {
								text    : 'メモ（下線のみ）',
								icon    : false,
								tooltip : 'メモ（下線のみ）',
								callback: wrapAsHtml('[st-mybox title="メモ" fontawesome="fa-file-text-o" color="#727272" bordercolor="#ff0000" bgcolor="#FAFAFA" borderwidth="0" borderradius="5" titleweight="bold" title_bordercolor="#757575" fontsize="" myclass="st-mybox-class st-title-under" margin="25px 0 25px 0"]<p>', '</p>[/st-mybox]')
							},
							'st_button_mybox_intitle_memo_border' : {
								text    : 'メモ（枠のみ）',
								icon    : false,
								tooltip : 'メモ（枠のみ）',
								callback: wrapAsHtml('[st-mybox title="メモ" fontawesome="fa-file-text-o" color="#727272" bordercolor="#f3f3f3" bgcolor="" borderwidth="3" borderradius="5" titleweight="bold" title_bordercolor="" fontsize="" myclass="st-mybox-class st-title-under" margin="25px 0 25px 0"]<p>', '</p>[/st-mybox]')
							},
							'st_button_mybox_intitle_memo_titleborder_border' : {
								text    : 'メモ（枠・下線あり）',
								icon    : false,
								tooltip : 'メモ（枠・下線あり）',
								callback: wrapAsHtml('[st-mybox title="メモ" fontawesome="fa-file-text-o" color="#727272" bordercolor="#f3f3f3" bgcolor="" borderwidth="3" borderradius="5" titleweight="bold" title_bordercolor="#757575" fontsize="" myclass="st-mybox-class st-title-under" margin="25px 0 25px 0"]<p>', '</p>[/st-mybox]')
							},
							'st_button_mybox_intitle_attention_titleborder' : {
								text    : '注意（下線のみ）',
								icon    : false,
								tooltip : '注意（下線のみ）',
								callback: wrapAsHtml('[st-mybox title="ここに注意" fontawesome="fa-exclamation-circle" color="#ef5350" bordercolor="#f3f3f3" bgcolor="#ffebee" borderwidth="" borderradius="5" titleweight="bold" title_bordercolor="#ef5350" fontsize="" myclass="st-mybox-class st-title-under" margin="25px 0 25px 0"]<p>', '</p>[/st-mybox]')
							},
					...
					'st_button_freebox_group'      : {
						...
						menu	: {
							'st_button_freebox_base'      : {
								text    : '基本',
								icon    : false,
								callback: wrapAsHtml('[st-midasibox title="見出し（全角15文字）" fontawesome="" bordercolor="" color="" bgcolor="" borderwidth="" borderradius="" titleweight="bold" myclass=""]<p>', '</p>[/st-midasibox]')
							},
							'st_button_freebox_attention'      : {
								text    : '注意',
								icon    : false,
								callback: wrapAsHtml('[st-midasibox title="注意" fontawesome="fa-exclamation-circle faa-flash animated" bordercolor="#f44336" color="" bgcolor="#ffebee" borderwidth="" borderradius="5" titleweight="bold" myclass=""]<p>', '</p>[/st-midasibox]')
							},
							'st_button_freebox_question'      : {
								text    : 'はてな',
								icon    : false,
								callback: wrapAsHtml('[st-midasibox title="はてな" fontawesome="fa-question-circle faa-ring animated" bordercolor="#03A9F4" color="#fff" bgcolor="#E1F5FE" borderwidth="" borderradius="5" titleweight="bold" myclass=""]<p>', '</p>[/st-midasibox]')
							},
							'st_button_freebox_point'      : {
								text    : 'ポイント',
								icon    : false,
								callback: wrapAsHtml('[st-midasibox title="ポイント" fontawesome="fa-check-circle faa-ring animated" bordercolor="#FFC107" color="" bgcolor="#FFFDE7" borderwidth="" borderradius="5" titleweight="bold" myclass=""]<p>', '</p>[/st-midasibox]')
							},
							'st_button_freebox_memo'      : {
								text    : 'メモ',
								icon    : false,
								callback: wrapAsHtml('[st-midasibox title="メモ" fontawesome="fa-file-text-o faa-float animated" bordercolor="#757575" color="" bgcolor="#FAFAFA" borderwidth="" borderradius="5" titleweight="bold" myclass=""]<p>', '</p>[/st-midasibox]')
							},
							'st_button_freebox_base_intitle'      : {
								text    : '基本（タイトル幅100%）',
								icon    : false,
								callback: wrapAsHtml('[st-midasibox-intitle title="見出し（全角15文字）" fontawesome="" bordercolor="" color="" bgcolor="" borderwidth="" borderradius="" titleweight="bold" myclass=""]<p>', '</p>[/st-midasibox-intitle]')
							},
							'st_button_freebox_attention_intitle'      : {
								text    : '注意（タイトル幅100%）',
								icon    : false,
								callback: wrapAsHtml('[st-midasibox-intitle title="注意" fontawesome="fa-exclamation-circle faa-flash animated" bordercolor="#f44336" color="" bgcolor="#ffebee" borderwidth="" borderradius="5" titleweight="bold" myclass=""]<p>', '</p>[/st-midasibox-intitle]')
							},
							'st_button_freebox_question_intitle'      : {
								text    : 'はてな（タイトル幅100%）',
								icon    : false,
								callback: wrapAsHtml('[st-midasibox-intitle title="はてな" fontawesome="fa-question-circle faa-ring animated" bordercolor="#03A9F4" color="#fff" bgcolor="#E1F5FE" borderwidth="" borderradius="5" titleweight="bold" myclass=""]<p>', '</p>[/st-midasibox-intitle]')
							},
							'st_button_freebox_point_intitle'      : {
								text    : 'ポイント（タイトル幅100%）',
								icon    : false,
								callback: wrapAsHtml('[st-midasibox-intitle title="ポイント" fontawesome="fa-check-circle faa-ring animated" bordercolor="#FFC107" color="" bgcolor="#FFFDE7" borderwidth="" borderradius="5" titleweight="bold" myclass=""]<p>', '</p>[/st-midasibox-intitle]')
							},
							'st_button_freebox_memo_intitle'      : {
								text    : 'メモ（タイトル幅100%）',
								icon    : false,
								callback: wrapAsHtml('[st-midasibox-intitle title="メモ" fontawesome="fa-file-text-o faa-float animated" bordercolor="#757575" color="" bgcolor="#FAFAFA" borderwidth="" borderradius="5" titleweight="bold" myclass=""]<p>', '</p>[/st-midasibox-intitle]')
							},
						},
					},
					'st_button_memobox'     : {
					...
					'st_button_slidebox'     : {
						text    : 'スライドボックス',
						icon    : false,
						callback: wrapAsHtml('[st-slidebox fontawesome="" text="+ クリックして下さい" bgcolor="" color="#1a1a1a" margin_bottom="20"]<p>','</p>[/st-slidebox]')
					},
					...
					'st_pre_shortcode'   : {
						text    : 'pre: shortcode',
						icon    : false,
						callback: wrapAsHtml('[st-pre-sc myclass="" text="shortcode" fontawesome=""]<p>', '</p>[/st-pre-sc]')
					},
				},
			},
				...
				'st_button_originalbutton_c': {
					...
					menu: {
							'st_button_originalbutton_default': {
								text    : '基本',
							icon    : false,
							callback: setAsText('[st-mybutton class="" url="#" title="ボタン" rel="" fontawesome="" target="" color="#000000" bgcolor="#FFF" bgcolor_top="" bordercolor="#CCC" borderwidth="3" borderradius="0" fontsize="" fontweight="" width="100" fontawesome_after="" shadow="" ref="" beacon=""]')
							},
							'st_button_originalbutton_kuwasiku': {
								text    : '詳しくはコチラ（オレンジ）',
							icon    : false,
							callback: setAsText('[st-mybutton url="#" title="詳しくはコチラ" rel="" fontawesome="" target="" color="#fff" bgcolor="#FFD54F" bgcolor_top="#ffdb69" bordercolor="#FFEB3B" borderwidth="1" borderradius="5" fontsize="" fontweight="bold" width="" fontawesome_after="fa-angle-right" shadow="#FFB300" ref="on" beacon=""]')
							},
							'st_button_originalbutton_kuwasiku_red': {
								text    : '詳しくはコチラ（レッド）',
							icon    : false,
							callback: setAsText('[st-mybutton url="#" title="詳しくはコチラ" rel="" fontawesome="" target="_blank" color="#fff" bgcolor="#e53935" bgcolor_top="#f44336" bordercolor="#e57373" borderwidth="1" borderradius="5" fontsize="" fontweight="bold" width="" fontawesome_after="fa-angle-right" shadow="#c62828" ref="on" beacon=""]')
							},
							'st_button_originalbutton_kuwasiku_green': {
								text    : '詳しくはコチラ（グリーン）',
							icon    : false,
							callback: setAsText('[st-mybutton url="#" title="詳しくはコチラ" rel="" fontawesome="" target="_blank" color="#fff" bgcolor="#43A047" bgcolor_top="#66BB6A" bordercolor="#81C784" borderwidth="1" borderradius="5" fontsize="" fontweight="bold" width="" fontawesome_after="fa-angle-right" shadow="#388E3C" ref="on" beacon=""]')
							},
							'st_button_originalbutton_kuwasiku_blue': {
								text    : '詳しくはコチラ（ブルー）',
							icon    : false,
							callback: setAsText('[st-mybutton url="#" title="詳しくはコチラ" rel="" fontawesome="" target="_blank" color="#fff" bgcolor="#039BE5" bgcolor_top="#29B6F6" bordercolor="#4FC3F7" borderwidth="1" borderradius="5" fontsize="" fontweight="bold" width="" fontawesome_after="fa-angle-right" shadow="#039BE5" ref="on" beacon=""]')
							},
							'st_button_originalbutton_contact': {
								text    : 'お問合せ',
							icon    : false,
							callback: setAsText('[st-mybutton url="#" title="お問合せ" rel="" fontawesome="fa-envelope" target="" color="#fff" bgcolor="#03A9F4" bgcolor_top="#14b4fc" bordercolor="#039BE5" borderwidth="1" borderradius="5" fontsize="" fontweight="" width="90" fontawesome_after="" shadow="#039BE5" ref="on" beacon=""]')
							},
							'st_button_originalbutton_orange': {
								text    : 'もっと詳しく（オレンジ）',
							icon    : false,
							callback: setAsText('[st-mybutton url="#" title="もっと詳しく" rel="" fontawesome="" target="" color="#fff" bgcolor="#FFD54F" bgcolor_top="#ffdb69" bordercolor="#FFEB3B" borderwidth="1" borderradius="30" fontsize="85" fontweight="" width="90" fontawesome_after="fa-angle-right" shadow="" ref="on" beacon=""]')
							},
							'st_button_originalbutton_pink': {
								text    : 'もっと詳しく（ピンク）',
							icon    : false,
							callback: setAsText('[st-mybutton url="#" title="もっと詳しく" rel="" fontawesome="" target="" color="#fff" bgcolor="#F48FB1" bgcolor_top="#f6a6c1" bordercolor="#F48FB1" borderwidth="1" borderradius="30" fontsize="85" fontweight="" width="90" fontawesome_after="fa-angle-right" shadow="" ref="on" beacon=""]')
							},
							'st_button_originalbutton_blue': {
								text    : 'もっと詳しく（ブルー）',
							icon    : false,
							callback: setAsText('[st-mybutton url="#" title="もっと詳しく" rel="" fontawesome="" target="" color="#fff" bgcolor="#4FC3F7" bgcolor_top="#67cbf8" bordercolor="#4FC3F7" borderwidth="1" borderradius="30" fontsize="85" fontweight="" width="90" fontawesome_after="fa-angle-right" shadow="" ref="on" beacon=""]')
							},
							'st_button_originalbutton_under': {
								text    : '人気ランキング',
							icon    : false,
							callback: setAsText('[st-mybutton url="#" title="人気ランキング" rel="" fontawesome="st-svg-oukan" target="" color="#fff" bgcolor="#FBC02D" bgcolor_top="#fbc846" bordercolor="#FBC02D" borderwidth="1" borderradius="5" fontsize="110" fontweight="bold" width="90" fontawesome_after="" shadow="" ref="on" beacon=""]')
							},
							'st_button_originalbutton_ranking_under': {
								text    : 'ランキングはコチラ',
							icon    : false,
							callback: setAsText('[st-mybutton class="" url="#ranking" title="ランキングはコチラ" rel="" fontawesome="fa-angle-double-down" target="" color="#1a1a1a" bgcolor="#fdef4e" bgcolor_top="" bordercolor="#fceb1c" borderwidth="1" borderradius="" fontsize="95" fontweight="" width="" fontawesome_after="" shadow="" ref="" beacon=""]')
							},
					...
					menu: {
							'st_button_originalbutton_radius_default': {
								text    : '基本',
							icon    : false,
							callback: setAsText('[st-mybutton class="" url="#" title="角丸ボタン" rel="" fontawesome="" target="" color="#424242" bgcolor="" bgcolor_top="" bordercolor="#CCC" borderwidth="5" borderradius="30" fontsize="" fontweight="bold" width="" fontawesome_after="fa-chevron-right" shadow="" ref="" beacon=""]')
							},
							'st_button_originalbutton_radius_kuwasiku': {
								text    : '詳しくはコチラ（オレンジ）',
							icon    : false,
							callback: setAsText('[st-mybutton class="" url="#" title="角丸ボタン" rel="" fontawesome="" target="" color="#FFB74D" bgcolor="" bgcolor_top="" bordercolor="#FFB74D" borderwidth="5" borderradius="30" fontsize="" fontweight="bold" width="" fontawesome_after="fa-chevron-right" shadow="" ref="" beacon=""]')
							},
							'st_button_originalbutton_radius_kuwasiku_red': {
								text    : '詳しくはコチラ（レッド）',
							icon    : false,
							callback: setAsText('[st-mybutton class="" url="#" title="角丸ボタン" rel="" fontawesome="" target="" color="#ef5350" bgcolor="" bgcolor_top="" bordercolor="#ef5350" borderwidth="5" borderradius="30" fontsize="" fontweight="bold" width="" fontawesome_after="fa-chevron-right" shadow="" ref="" beacon=""]')
							},
							'st_button_originalbutton_radius_kuwasiku_green': {
								text    : '詳しくはコチラ（グリーン）',
							icon    : false,
							callback: setAsText('[st-mybutton class="" url="#" title="角丸ボタン" rel="" fontawesome="" target="" color="#9CCC65" bgcolor="" bgcolor_top="" bordercolor="#9CCC65" borderwidth="5" borderradius="30" fontsize="" fontweight="bold" width="" fontawesome_after="fa-chevron-right" shadow="" ref="" beacon=""]')
							},
							'st_button_originalbutton_radius_kuwasiku_blue': {
								text    : '詳しくはコチラ（ブルー）',
							icon    : false,
							callback: setAsText('[st-mybutton class="" url="#" title="角丸ボタン" rel="" fontawesome="" target="" color="#4FC3F7" bgcolor="" bgcolor_top="" bordercolor="#4FC3F7" borderwidth="5" borderradius="30" fontsize="" fontweight="bold" width="" fontawesome_after="fa-chevron-right" shadow="" ref="" beacon=""]')
							},
						},
					},
					...
					menu: {
							'st_button_originalbutton_mini_default': {
								text    : '基本',
							icon    : false,
							callback: setAsText('[st-mybutton-mini url="#" title="ボタン" rel="" fontawesome="" target="" color="#000000" bgcolor="#f3f3f3" bgcolor_top="" bordercolor="" borderwidth="" borderradius="3" fontsize="" fontweight="" fontawesome_after="" shadow="#BDBDBD" ref="" beacon=""]')
							},
							'st_button_originalbutton_mini_kuwasiku': {
								text    : '詳しくはコチラ（オレンジ）',
							icon    : false,
							callback: setAsText('[st-mybutton-mini url="#" title="詳しくはコチラ" rel="" fontawesome="" target="" color="#fff" bgcolor="#FFB74D" bgcolor_top="" bordercolor="" borderwidth="" borderradius="5" fontsize="" fontweight="" fontawesome_after="fa-angle-right" shadow="#FFB300" ref="" beacon=""]')
							},
							'st_button_originalbutton_mini_kuwasiku_red': {
								text    : '詳しくはコチラ（レッド）',
							icon    : false,
							callback: setAsText('[st-mybutton-mini url="#" title="詳しくはコチラ" rel="" fontawesome="" target="_blank" color="#fff" bgcolor="#ef5350" bgcolor_top="" bordercolor="" borderwidth="" borderradius="5" fontsize="" fontweight="" fontawesome_after="fa-angle-right" shadow="#f44336" ref="" beacon=""]')
							},
							'st_button_originalbutton_mini_kuwasiku_green': {
								text    : '詳しくはコチラ（グリーン）',
							icon    : false,
							callback: setAsText('[st-mybutton-mini url="#" title="詳しくはコチラ" rel="" fontawesome="" target="_blank" color="#fff" bgcolor="#9CCC65" bgcolor_top="" bordercolor="" borderwidth="" borderradius="5" fontsize="" fontweight="" fontawesome_after="fa-angle-right" shadow="#8BC34A" ref="" beacon=""]')
							},
							'st_button_originalbutton_mini_kuwasiku_blue': {
								text    : '詳しくはコチラ（ブルー）',
							icon    : false,
							callback: setAsText('[st-mybutton-mini url="#" title="詳しくはコチラ" rel="" fontawesome="" target="_blank" color="#fff" bgcolor="#4FC3F7" bgcolor_top="" bordercolor="" borderwidth="" borderradius="5" fontsize="" fontweight="" fontawesome_after="fa-angle-right" shadow="#03A9F4" ref="" beacon=""]')
							},
						},
					},
					...
					menu: {
							'st_button_originalbutton_mc_orange': {
								text: 'オレンジ',
								icon    : false,
								callback: setAsText('[st-mcbutton url="#" title="今すぐ申し込む" rel="" fontawesome="" target="" color="#fff" bgcolor="#FFD54F" bgcolor_top="#ffdb69" bordercolor="#FFEB3B" borderwidth="1" borderradius="5" fontweight="bold" fontsize="120" width="90" fontawesome_after="fa-chevron-right" shadow="#FFB300" ref="on" mcbox_bg="#fafafa" mcbox_color="" mcbox_title="太字のテキスト" beacon=""]※マイクロコピーを書いてみよう[/st-mcbutton]')
							},
							'st_button_originalbutton_mc_red': {
								text: 'レッド',
								icon    : false,
								callback: setAsText('[st-mcbutton url="#" title="今すぐ申し込む" rel="" fontawesome="" target="" color="#fff" bgcolor="#e53935" bgcolor_top="#f44336" bordercolor="#e57373" borderwidth="1" borderradius="5" fontweight="bold" fontsize="120" width="90" fontawesome_after="fa-chevron-right" shadow="#c62828" ref="on" mcbox_bg="#fafafa" mcbox_color="" mcbox_title="太字のテキスト" beacon=""]※マイクロコピーを書いてみよう[/st-mcbutton]')
							},
							...
							'st_button_originalbutton_mc_blue': {
								text: 'ブルー',
								icon    : false,
								callback: setAsText('[st-mcbutton url="#" title="今すぐ申し込む" rel="" fontawesome="" target="" color="#fff" bgcolor="#039BE5" bgcolor_top="#29B6F6" bordercolor="#4FC3F7" borderwidth="1" borderradius="5" fontweight="bold" fontsize="120" width="90" fontawesome_after="fa-chevron-right" shadow="#039BE5" ref="on" mcbox_bg="#fafafa" mcbox_color="" mcbox_title="太字のテキスト" beacon=""]※マイクロコピーを書いてみよう[/st-mcbutton]')
							},
						},
					},
					'st_box_btn_c': {
					...
					menu: {
							'st_box_btn': {
								...
								icon    : false,
								tooltip : '基本（4列）',
								callback: setAsText('[st-box-btn myclass="" pc_show="4" margin="0 0 20px 0" type=""]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューA" subtext="" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューB" subtext="" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューC" subtext="" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューD" subtext="" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[/st-box-btn]')
							},
							'st_box_btn_sub': {
								text    : 'サブあり（4列）',
								icon    : false,
								tooltip : 'サブあり（4列）',
								callback: setAsHtml('[st-box-btn myclass="" pc_show="4" margin="0 0 20px 0" type=""]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューA" subtext="サブテキスト" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューB" subtext="サブテキスト" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューC" subtext="サブテキスト" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューD" subtext="サブテキスト" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[/st-box-btn]')
							},
							'st_box_btn_vertical': {
								text    : '縦並びタイプ',
								icon    : false,
								tooltip : '縦並びタイプ',
								callback: setAsText('[st-box-btn myclass="" pc_show="4" margin="0 0 20px 0" type="vertical"]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューA" subtext="" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューB" subtext="" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューC" subtext="" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューD" subtext="" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"]<br>[/st-box-btn]')
							},
							...
							'st_box_btn_vertical_one': {
								...
								icon    : false,
								tooltip : 'ボタンバナー風デザイン',
								callback: setAsText('[st-box-btn myclass="" pc_show="1" margin="0 0 10px 0" type="vertical"][st-box-btn-list icon_image="" fontawesome="fa-wordpress" icon_size="" text="メニューA" subtext="サブテキスト" url="" target="" rel="" bgcolor="" color="" fontsize="90" fontweight="bold"][/st-box-btn]')
							},
						},
					},
					'st_btnlink_main': {
					...
					'st_button_responbox_pc_tab'  : {
						...
						menu: {
							...
							'st_button_responbox70'    : {
								text    : '左右70:30%',
								icon    : false,
								callback: setAsHtml('<div class="clearfix responbox70"><div class="lbox"><p>このテキストは最後に消して下さい（70%）</p></div><div class="rbox"><p>このテキストは最後に消して下さい（30%）※モバイル（599px以下）ではこちらが上になります</p></div></div><br>')
							},
							'st_button_responbox'    : {
								text    : '左右40:60%',
								icon    : false,
							...
							'st_button_responbox60'    : {
								text    : '左右60:40%',
								icon    : false,
								callback: setAsHtml('<div class="clearfix responbox60"><div class="lbox"><p>このテキストは最後に消して下さい（60%）</p></div><div class="rbox"><p>このテキストは最後に消して下さい（40%）※モバイル（599px以下）ではこちらが上になります</p></div></div><br>')
							},
					...
					'st_tab_btn': {
						...
						menu: {
							'st_tab_btn2'       : {
								text    : '2つ',
								icon    : false,
								callback: setAsHtml('[st-tab-content memo="全体を包むボックスです" type="button" myclass="st-radius"]<br>[st-input-tab fontawesome="" text="タブ1" bgcolor="" bordercolor="" color="" fontweight="" checked="checked"]<br>[st-input-tab fontawesome="" text="タブ2" bgcolor="" bordercolor="" color="" fontweight="" checked=""]<br>[st-tab-main bgcolor="" bordercolor=""]<p>タブ1のコンテンツ</p>[/st-tab-main][st-tab-main bgcolor="" bordercolor=""]<p>タブ2のコンテンツ</p>[/st-tab-main]<br>[/st-tab-content]')
							},
							'st_tab_btn3'       : {
								text    : '3つ',
								icon    : false,
								callback: setAsHtml('[st-tab-content memo="全体を包むボックスです" type="button" myclass="st-radius"]<br>[st-input-tab fontawesome="" text="タブ1" bgcolor="" bordercolor="" color="" fontweight="" checked="checked"]<br>[st-input-tab fontawesome="" text="タブ2" bgcolor="" bordercolor="" color="" fontweight="" checked=""]<br>[st-input-tab fontawesome="" text="タブ3" bgcolor="" bordercolor="" color="" fontweight="" checked=""]<br>[st-tab-main bgcolor="" bordercolor=""]<p>タブ1のコンテンツ</p>[/st-tab-main][st-tab-main bgcolor="" bordercolor=""]<p>タブ2のコンテンツ</p>[/st-tab-main][st-tab-main bgcolor="" bordercolor=""]<p>タブ3のコンテンツ</p>[/st-tab-main]<br>[/st-tab-content]')
							},
							'st_tab_btn4'       : {
								text    : '4つ',
								icon    : false,
								callback: setAsHtml('[st-tab-content memo="全体を包むボックスです" type="button" myclass="st-radius"]<br>[st-input-tab fontawesome="" text="タブ1" bgcolor="" bordercolor="" color="" fontweight="" checked="checked"]<br>[st-input-tab fontawesome="" text="タブ2" bgcolor="" bordercolor="" color="" fontweight="" checked=""]<br>[st-input-tab fontawesome="" text="タブ3" bgcolor="" bordercolor="" color="" fontweight="" checked=""]<br>[st-input-tab fontawesome="" text="タブ4" bgcolor="" bordercolor="" color="" fontweight="" checked=""]<br>[st-tab-main bgcolor="" bordercolor=""]<p>タブ1のコンテンツ</p>[/st-tab-main][st-tab-main bgcolor="" bordercolor=""]<p>タブ2のコンテンツ</p>[/st-tab-main][st-tab-main bgcolor="" bordercolor=""]<p>タブ3のコンテンツ</p>[/st-tab-main][st-tab-main bgcolor="" bordercolor=""]<p>タブ4のコンテンツ</p>[/st-tab-main]<br>[/st-tab-content]')
							},
						},
					},
					'st_tab': {
						...
						menu: {
							'st_button_tab2'       : {
								text    : '2つ',
								icon    : false,
								callback: setAsHtml('[st-tab-content memo="全体を包むボックスです" myclass=""]<br>[st-input-tab fontawesome="" text="タブ1" bgcolor="#fff" bordercolor="" color="#1a1a1a" fontweight="" width="45" value="1" checked="checked"]<br>[st-input-tab fontawesome="" text="タブ2" bgcolor="#fff" bordercolor="" color="#1a1a1a" fontweight="" width="45" value="2" checked=""]<br>[st-tab-main bgcolor="" bordercolor="" value="1"]<p>タブ1のコンテンツ</p>[/st-tab-main][st-tab-main bgcolor="" bordercolor="" value="2"]<p>タブ2のコンテンツ</p>[/st-tab-main]<br>[/st-tab-content]')
							},
							'st_button_tab3'       : {
								text    : '3つ',
								icon    : false,
								callback: setAsHtml('[st-tab-content memo="全体を包むボックスです" myclass=""]<br>[st-input-tab fontawesome="" text="タブ1" bgcolor="#fff" bordercolor="" color="#1a1a1a" fontweight="" width="30" value="1" checked="checked"]<br>[st-input-tab fontawesome="" text="タブ2" bgcolor="#fff" bordercolor="" color="#1a1a1a" fontweight="" width="30" value="2" checked=""]<br>[st-input-tab text="タブ3" bgcolor="#fff" bordercolor="" color="#1a1a1a" fontweight="" width="30" value="3" checked=""]<br>[st-tab-main bgcolor="" bordercolor="" value="1"]<p>タブ1のコンテンツ</p>[/st-tab-main][st-tab-main bgcolor="" bordercolor="" value="2"]<p>タブ2のコンテンツ</p>[/st-tab-main][st-tab-main bgcolor="" bordercolor="" value="3"]<p>タブ3のコンテンツ</p>[/st-tab-main]<br>[/st-tab-content]')
							},
						},
					},
					'st_timeline': {
					...
					'st_button_blogcard_type' : {
						...
						menu: {
							'st_button_blogcard_type_text_sankou'  : {
								text    : '参考',
								icon    : false,
								callback: wrapAsText('[st-card myclass="st-no-shadow" id="', '" label="参考" pc_height="" name="" bgcolor="#cccccc" color="#ffffff" fontawesome="fa-file-text-o" readmore="on" thumbnail="on" type="text"]')
							},
					...
					'st_webicon': {
						...
						menu: {
							...
							'st_button_webicon_chevron_angle_right'  : {
								text    : '矢印右3',
								icon    : 'fa-angle-right',
								callback: setAsText('fa-angle-right')
							},
							'st_button_webicon_chevron_angle_down'  : {
								text    : '矢印下3',
								icon    : 'fa-angle-down',
								callback: setAsText('fa-angle-down')
							},
	...
	function getButtonDefinition(editor) {
		...
		return {
			...
			'st_button_blogcard' : {
				...
				icon    : false,
				tooltip : 'ブログカード',
				callback: wrapAsText('[st-card myclass="" id="', '" label="" pc_height="" name="" bgcolor="" color="" fontawesome="" readmore="on" thumbnail="on" type=""]')
			},
			'st_button_st_toc' : {
				text    : '目次',
				icon    : 'fa-bookmark',
