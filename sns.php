...
?>
	...
	<div class="sns <?php echo $sns_top; ?>">
	<ul class="clearfix">
		...
		<?php if ( trim( $GLOBALS['stdata413'] ) === '' ): ?>
			<!--はてブボタン-->
			<li class="hatebu">       
				<a href="//b.hatena.ne.jp/entry/<?php the_permalink(); ?>" class="hatena-bookmark-button" data-hatena-bookmark-layout="simple" title="<?php echo esc_attr( $title ); ?>" rel="nofollow"><i class="fa st-svg-hateb"></i><span class="snstext <?php echo $plug; ?>" >Hatena</span>
