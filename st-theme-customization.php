...
if ( !function_exists( 'st_get_plain_theme_mod_defaults' ) ) {
	function st_get_plain_theme_mod_defaults() {
		return array(
			...
			'st_icon_logo_width'      => '', //アイコンロゴの最大サイズ（px）
			...
			'st_search_form_text'            => '検索したいテキストを入力', // 検索フォーム内のテキスト
			...
			'st_sticky_menu'                       => '',        //スマホメニューfix
			'st_sticky_primary_menu_side'          => '',        //スクロールで内容対象をヘッダー用メニュー（横列）に変更
			...
			'st_menu_sumart_footermenu_fontawesome' => '', //fontawesomeアイコンサイズ(%)
			...
			'st_boxnavimenu_fontawesome'  => '300', //fontawesomeアイコンサイズ（%）
			...
			'st_webicon_checkbox_simple' => '',    // チェックボックスのデザインをチェックのみにする
			...
			'st_toc_bgcolor'             => '', //背景色
			'st_toc_mokuzicolor_base'    => '', //基本（目次色/リスト数字/アイコン）
...
if (!function_exists( 'st_get_zentai_theme_mod_overrides' )) {
	function st_get_zentai_theme_mod_overrides() {
		...
		$zentai_overrides   = array(
			...
			'st_separator_bordercolor' => $keycolor,  //NEW ENTRYのボーダー色
			...
			'st_search_form_border_color'    => '', // 検索フォームの枠線
			'st_search_form_border_width'    => '', // 検索フォームの枠線の太さ
			'st_search_form_bg_color'        => '', // 検索フォームの背景色
			'st_search_form_text_color'      => '', // 検索フォーム内の文字色
			'st_search_form_icon_color'      => '', // 検索アイコンの色
			'st_search_form_icon_bg_color'   => '', // 検索アイコンの背景色
...
if ( !function_exists( 'st_get_var_theme_mod_maps' ) ) {
	function st_get_var_theme_mod_maps() {
		return array(
			...
			'st_icon_logo_width'       => 'st_icon_logo_width',      //アイコンロゴの最大サイズ（px）
			...
			'st_sticky_primary_menu_side' => 'st_sticky_primary_menu_side', //スクロールで内容対象をヘッダー用メニュー（横列）に変更
			...
			'st_menu_sumart_footermenu_fontawesome'    => 'st_menu_sumart_footermenu_fontawesome', //fontawesomeアイコンサイズ(%)
			...
			'st_boxnavimenu_fontawesome'  => 'st_boxnavimenu_fontawesome', //fontawesomeアイコンサイズ（%）
			...
			'st_toc_mokuzicolor_base'    => 'st_toc_mokuzicolor_base', //基本（目次色/リスト数字/アイコン）
	...
	if ( st_is_customizer_enabled() ) { // カスタマイザー有効化の有無
		...
		$wp_customize->add_control( 'st_menu_sumart_footermenu_fontawesome_c',
			array(
				...
				'label'       => '',
				'description' => 'fontawesomeアイコンサイズ(%)',
				'type'        => 'option',
			) );
			...
			$wp_customize->add_control( 'st_h2_designsetting',
				array(
					...
					'choices'     => array(
						...
						'underdotdesign'            => __( '破線アンダーラインに変更（※要ボーダー色）', '' ),
						'leftlinedesign'            => __( '左ラインデザインに変更（※要ボーダー色）', '' ),
						'checkboxdesign'            => __( 'チェック（ボックスタイプ）デザインに変更', '' ),
						''                          => __( 'なし', 'default' ),
					),
				) );
		elseif ( st_is_ver_af() ):
		...
		$wp_customize->add_control( 'st_separator_type',
			array(
				...
				'choices'     => array(
				''            => __( 'ノーマル', 'default' ),
				'border'      => __( 'ボーダー', 'default' ),
				'round'      => __( 'ラウンド', 'default' ),
				),
			) );
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'st_webicon_checkbox', array(
			'label'       => __( 'チェック（ボックスタイプ）', 'default' ),
			'description' => 'チェック（ボックスタイプ）色',
			'section'     => 'st_panel_maruno',
		...
		$wp_customize->add_control( 'st_webicon_checkbox_size_c',
			array(
				...
				'label'       => '',
				'description' => 'チェック（ボックスタイプ）サイズ（%）※微調整用',
				'type'        => 'option',
			) );
...
if(is_plugin_active( 'st-custom-search/st-custom-search.php' )):
		...
		$wp_customize->add_setting( 'st_toc_mokuzicolor_base',
			array(
				'default'              => $defaults['st_toc_mokuzicolor_base'],
				'sanitize_callback'    => 'sanitize_hex_color',
				'sanitize_js_callback' => 'maybe_hash_hex_color',
			) );
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'st_toc_mokuzicolor_base', array(
			'label'       => __( '', 'default' ),
			'section'     => 'st_panel_toc_sugoi',
			'description' => '基本（目次色/リスト数字/アイコン）',
			'settings'    => 'st_toc_mokuzicolor_base',
		) ) );
		...
		if ( st_is_st_toc_enabled() ) {
			...
			$wp_customize->add_control( 'st_toc_list_style',
				array(
					...
					'choices'     => array(
						'default'        => 'デフォルト',
						'paper'          => 'ペーパー風（※position:stickyは使用できなくなります）',
						'timeline'       => 'タイムライン',
