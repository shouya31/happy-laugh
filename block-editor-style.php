...
<?php if ( isset ( $GLOBALS[ "stdata240" ] ) && $GLOBALS[ "stdata240" ] === 'yes' ): ?>
	...
	<?php if ( $st_webicon_question ): ?>
		.editor-styles-wrapper .hatenamark2.on-color:not(.st-css-no):before,
		.editor-styles-wrapper .fa-question-circle:not(.st-css-no) {
			color: <?php echo $st_webicon_question; ?>;
		}
	<?php endif; ?>

	<?php if ( $st_webicon_check ): ?>
		.editor-styles-wrapper .checkmark2.on-color:not(.st-css-no):before,
		.editor-styles-wrapper .fa-check-circle:not(.st-css-no) {
	...
	<?php elseif ( trim( $st_h3_designsetting ) !== '' && $st_h3_designsetting === 'leftlinedesign' ): //左ラインのみ ?>
		...
		<?php if ( $st_webicon_checkbox_simple ): // チェックボックスのデザインをチェックのみにする ?>
			...
			.editor-styles-wrapper .h3modoki,
			.editor-styles-wrapper h3:not(.st-css-no):not(.st-matome):not(.rankh3):not(.post-card-title):not(#reply-title) {
				position: relative;
				display: block;
				line-height: 1.5;
				margin-bottom: 20px;
			...
			.editor-styles-wrapper .h3modoki:before,
			.editor-styles-wrapper h3:not(.st-css-no):not(.st-matome):not(.rankh3):not(.post-card-title):not(#reply-title):before {
				position: absolute;
				top: calc(50% - .75em)!important;
				left: 10px;
				content: "\f00c";
			...
			.editor-styles-wrapper .h3modoki:after,
			.editor-styles-wrapper h3:not(.st-css-no):not(.st-matome):not(.rankh3):not(.post-card-title):not(#reply-title):after {
				content: none;
			}
	...
	<?php if ( $st_h4_no_css ): //カスタマイザーのCSSを無効化
		...
		<?php if($st_h4_bg_radius): //h4 ?>
			/* 角丸 */
			.editor-styles-wrapper .h4modoki,
			.editor-styles-wrapper h4:not(.st-css-no):not(.st-matome):not(.rankh4):not(.post-card-title):not(#reply-title):not(.point){
				border-radius:5px;
			}
		<?php endif;  ?>
		...
		<?php if ( ( trim( $st_h4hukidasi_design ) !== '') && ( $st_h4hukidasi_design === 'hukidasidesign' ) ): //吹き出しデザイン ?>
			...
			.editor-styles-wrapper h4:not(.st-css-no):not(.st-matome):not(.rankh4):not(.post-card-title):not(#reply-title):not(.point):after {
			...
			.editor-styles-wrapper h4:not(.st-css-no):not(.st-matome):not(.rankh4):not(.post-card-title):not(#reply-title):not(.point):before {
				border-top: 10px solid <?php echo $st_h4bgcolor; ?>;
				content: '';
				position: absolute;
				border-right: 10px solid transparent;
		...
		<?php elseif ( ( trim( $st_h4hukidasi_design ) !== '') && ( $st_h4hukidasi_design === 'dogears' ) ): //耳折れデザイン ?>
			...
			.editor-styles-wrapper .h4modoki:before,
			.editor-styles-wrapper h4:not(.st-css-no):not(.st-matome):not(.rankh4):not(.point):before{
				content: '';
				border-style: solid;
				border-color: transparent #fff transparent transparent;
			...
			.editor-styles-wrapper .h4modoki:after,
			.editor-styles-wrapper h4:not(.st-css-no):not(.st-matome):not(.rankh4):not(.point):after{
				content: '';
				border-style: solid;
	...
	<?php if ( $st_h5_no_css ): //カスタマイザーのCSSを無効化
		...
		<?php if($st_h5_bg_radius): //h5 ?>
			/* 角丸 */
			.editor-styles-wrapper .h5modoki,
			.editor-styles-wrapper h5:not(.st-css-no):not(.st-matome):not(.rankh5):not(.post-card-title):not(#reply-title):not(.st-cardbox-t):not(.kanren-t):not(.popular-t):not(.post-card-title) {
				border-radius:5px;
			}
		<?php endif;  ?>
		...
		<?php if ( ( trim( $st_h5hukidasi_design ) !== '') && ( $st_h5hukidasi_design === 'hukidasidesign' ) ): //吹き出しデザイン ?>
			...
			.editor-styles-wrapper h5:not(.st-css-no):not(.st-matome):not(.rankh5):not(.post-card-title):not(#reply-title):not(.st-cardbox-t):not(.kanren-t):not(.popular-t):not(.post-card-title):after {
			...
			.editor-styles-wrapper h5:not(.st-css-no):not(.st-matome):not(.rankh5):not(.post-card-title):not(#reply-title):not(.st-cardbox-t):not(.kanren-t):not(.popular-t):not(.post-card-title):before {
				border-top: 10px solid <?php echo $st_h5bgcolor; ?>;
				content: '';
				position: absolute;
				border-right: 10px solid transparent;
